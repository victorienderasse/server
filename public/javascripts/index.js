...
$(function(){
    ...
    var widthImg = widthIntro - 17;
    $('#intro').attr('style','width:'+widthImg+'px; height:'+heightImg+'px;margin-top:50px; background-image: url("/public/images/Intro2.jpg"); background-repeat: no-repeat; background-size: '+widthImg+'px '+heightImg+'px;');
